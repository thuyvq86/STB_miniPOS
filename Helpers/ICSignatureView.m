...
- (UIImage *)getSignatureData {
	...
	_bitmapContext = CGBitmapContextCreate(_bitmapBuffer, _width, _height, _bitsPerComponent, _bytesPerRow, _colorSpace, kCGBitmapAlphaInfoMask & kCGImageAlphaPremultipliedLast);
