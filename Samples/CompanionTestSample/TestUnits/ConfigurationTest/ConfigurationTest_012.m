...
#import "ConfigurationTest_012.h"

@implementation ConfigurationTest_012
...
+(NSString *)title {
	return @"Print Text Overflow";
}


+(NSString *)subtitle {
	return @"Print long text strings";
}

+(NSString *)instructions {
	return @"Open the printer. Choose the length of the text and print. This will print a string compsed of \"length\" '*' character";
}
...
-(void)backgroundPrintText {
    ...
    NSUInteger stringLength = [self.textCharacterCount.text intValue];
