...
-(void)loadConfiguration {
    ...
    //Update UI Elements
    self.tpvNumber.text                             = [NSString stringWithFormat:@"%d", settingsManager.tpvNumber];
    self.cashNumber.text                            = [NSString stringWithFormat:@"%d", settingsManager.cashNumber];
    self.paymentApplicationNumber.text              = [NSString stringWithFormat:@"%d", settingsManager.paymentApplicationNumber];
    self.transactionTimeout.text                    = [NSString stringWithFormat:@"%d", settingsManager.doTransactionTimeout];
    self.useExtendedTransaction.on                  = settingsManager.useExtendedTransaction;
    self.receiptTextSize.text                       = [NSString stringWithFormat:@"%d", settingsManager.receiptTextSize];
