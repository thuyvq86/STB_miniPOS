...
#import "PPPTest_007.h"

@implementation PPPTest_007
...
+(NSString *)subtitle {
	return @"iOS to Telium Bridge Local";
}
...
-(void)pppChannelDidOpen {
    ...
    [self.pppChannel addiOSToTerminalBridgeLocalOnPort:[self.textPortForExternalConnections.text integerValue]];
