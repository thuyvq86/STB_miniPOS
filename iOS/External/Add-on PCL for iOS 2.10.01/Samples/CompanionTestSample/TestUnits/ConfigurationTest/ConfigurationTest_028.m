...
#import "ConfigurationTest_028.h"

extern char tiger[];

@implementation ConfigurationTest_028
...
-(void)viewDidLoad {
    ...
    self.buttonPrintBitmap  = [self addButtonWithTitle:@"Print multiple Bitmap" andAction:@selector(printBitmap)];
...
-(void)backgroundPrintBitmap {
    ...
    iBPResult retValue = [self.configurationChannel iBPPrintBitmap:bitmap lastBitmap:FALSE];
    [self.configurationChannel iBPPrintBitmap:bitmap lastBitmap:TRUE];
    [self.configurationChannel iBPPrintBitmap:bitmap lastBitmap:FALSE];
    [self.configurationChannel iBPPrintBitmap:bitmap lastBitmap:TRUE];
    [self.configurationChannel iBPPrintBitmap:bitmap lastBitmap:TRUE];
    float totalTime = [self endTimeMeasure];
