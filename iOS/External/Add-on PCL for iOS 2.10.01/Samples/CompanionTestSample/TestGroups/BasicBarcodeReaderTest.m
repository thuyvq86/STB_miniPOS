...
-(void)barcodeData:(id)data ofType:(int)type {
	...
	[self clearAndLogMessage:[NSString stringWithFormat:@"Scan N° %06lld - Type: %@ - Code: %@ - Time Average: %f", barcodeCount,[ICBarCodeReader symbologyToText:type], (NSString*)data, scanTimeAverage]];
	[self beginTimeMeasure];
}
