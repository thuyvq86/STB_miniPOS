...
+(NSData *)image2Bitmap:(UIImage *)image {
	...
	header.filesz				= sizeof(bmpfile_magic) + sizeof(bmpfile_header) + sizeof(bmpfile_information) + size;
	...
	information.bmp_bytesz		= size;
	information.hres			= width;
	information.vres			= height;
