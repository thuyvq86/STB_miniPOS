...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Name the tab bar items
    [(UITabBarItem *)[self.tabBarController.tabBar.items objectAtIndex:0] setTitle:NSLocalizedString(@"DO_TRANSACTION", @"")];
    [(UITabBarItem *)[self.tabBarController.tabBar.items objectAtIndex:1] setTitle:NSLocalizedString(@"RECEIPT", @"")];
...
#pragma mark Load Signature View in Landscape Mode
...
-(void)loadSignatureViewInLandscapeModeWithSize:(CGSize)size andParent:(UIViewController *)parent {
    ...
    signatureViewController.parent                      = parent;
    ...
    //self.window.rootViewController = signatureViewController;
    [self.window.rootViewController presentModalViewController:signatureViewController animated:YES];
}
*/
