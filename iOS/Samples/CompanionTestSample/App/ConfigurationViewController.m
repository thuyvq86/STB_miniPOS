...
-(void)loadUserSettings {
    ...
    self.iOSTcpPclPort.text                             = [NSString stringWithFormat:@"%d", settingsManager.iOSTcpPclPort];
    self.terminalTcpPclPort.text                        = [NSString stringWithFormat:@"%d", settingsManager.terminalPclTcpPort];
