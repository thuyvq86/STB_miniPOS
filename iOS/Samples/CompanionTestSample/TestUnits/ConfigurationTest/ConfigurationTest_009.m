...
#import "ConfigurationTest_009.h"


@implementation ConfigurationTest_009
...
-(void)didSpmRespondedToDoTransaction:(BOOL)response withParameters:(ICTransactionReply)transactionReply {
